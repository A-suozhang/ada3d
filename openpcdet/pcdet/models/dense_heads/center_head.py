...
class CenterHead(nn.Module):
    ...
    def assign_targets(self, gt_boxes, feature_map_size=None, **kwargs):
        ...
        feature_map_stride = kwargs['feature_map_stride']
        ...
        for idx, cur_class_names in enumerate(self.class_names_each_head):
            ...
            for bs_idx in range(batch_size):
                ...
                heatmap, ret_boxes, inds, mask = self.assign_target_of_single_head(
                    ...
                    feature_map_stride= target_assigner_cfg.FEATURE_MAP_STRIDE if feature_map_stride is None else feature_map_stride,
                    num_max_objs=target_assigner_cfg.NUM_MAX_OBJS,
                    gaussian_overlap=target_assigner_cfg.GAUSSIAN_OVERLAP,
                    min_radius=target_assigner_cfg.MIN_RADIUS if min_radius is None else min_radius,
                )
        ...
        # torch.save(ret_dict['heatmaps'], 'debug_gt_heatmap.pth') # debug_only
